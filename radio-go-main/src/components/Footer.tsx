...
import { FaFacebook, FaTiktok, FaInstagram, FaTwitch, FaWhatsapp, FaEnvelope } from "react-icons/fa";
...
const Footer: React.FC<FooterProps> = ({ onAdminLoginClick, isAdmin }) => {
  ...
  const phoneNumber = '5491162676918';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <div className="space-y-2 text-slate-300">
              <a
                href="mailto:radiogodigital@gmail.com"
                className="flex flex-col xs:flex-row xs:items-center gap-2 hover:text-cyan-400 transition-colors group"
                aria-label="Enviar correo"
                target="_blank"
              >
                <FaEnvelope className="text-cyan-400 w-5 h-5" />
                <span className="text-sm sm:text-base break-all group-hover:text-cyan-400 transition-colors">radiogodigital@gmail.com</span>
              </a>
              <a
                href={whatsappLink}
                target="_blank"
